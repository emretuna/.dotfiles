...
local icons = {
  ...
  fw = { desc = get_icon("Frameworks", 1, true) .. "Frameworks" },
  xl = { desc = get_icon("Laravel", 1, true) .. "Laravel" }
}
...
maps.n["<leader>W"] = { function() vim.cmd "SudaWrite" end, desc = "Save as sudo" }
...
-- only useful when the option clipboard is commented on ./options.lua
...
if is_available "laravel.nvim" then
  maps.n["<leader>x"] = icons.fw
  maps.n["<leader>xl"] = icons.xl
  maps.n["<leader>xla"] = {
    function() vim.cmd "Laravel artisan" end,
    desc = "Laravel Artisan"
  }
  maps.n["<leader>xlr"] = {
    function() vim.cmd "Laravel routes" end,
    desc = "Laravel Routes"
  }
  maps.n["<leader>xll"] = {
    function() vim.cmd "Laravel related" end,
